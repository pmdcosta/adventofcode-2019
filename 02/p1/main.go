...
func main() {
	for i := 0; i < len(input); i = i + 4 {
		...
		var sub = input[i : i+4]
		handleOp(sub[0], input[sub[1]], input[sub[2]], sub[3])
	}
	fmt.Println(input)
}

func handleOp(op, arg1, arg2, pos int) {
	switch op {
	case 1:
		input[pos] = arg1 + arg2
	case 2:
